...
class ExcelReportGenerator(BaseModel):
    ...
    output_directory: str = Field(default="artifacts/reports", description="Output directory for reports")
    include_charts: bool = Field(default=True, description="Include charts in reports")
    include_formatting: bool = Field(default=True, description="Include advanced formatting")
    
    # Data sources
    data_collector: Optional[ComprehensiveDataCollector] = Field(default=None, description="Data collector")
    mortality_tracker: Optional[DeadColonyTracker] = Field(default=None, description="Mortality tracker")
    parameter_loader: Optional[ParameterLoader] = Field(default=None, description="Parameter loader")
    
    # Report configuration
    max_rows_per_sheet: int = Field(default=1000000, ge=1000, description="Maximum rows per sheet")
    decimal_places: int = Field(default=3, ge=0, le=10, description="Decimal places for numbers")
    ...
    def __init__(self, **data):
        ...
        self.number_style = {
            'number_format': f'0.{"0" * self.decimal_places}'
        }
    
    def generate_simulation_summary_report(self, simulation_data: Dict[str, Any]) -> str:
    ...
    def _create_overview_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_population_dynamics_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_energy_analysis_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_foraging_performance_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_environmental_conditions_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_summary_statistics_sheet(self, workbook: Workbook, simulation_data: Dict[str, Any]) -> None:
    ...
    def _create_population_chart(self, ws, data_rows: int) -> None:
    ...
    def _create_energy_chart(self, ws, data_rows: int) -> None:
    ...
    def _create_foraging_chart(self, ws, data_rows: int) -> None:
    ...
    def _create_environmental_chart(self, ws, data_rows: int) -> None:
    ...
    def _add_foraging_summary_statistics(self, ws, foraging_data: List[Dict[str, Any]]) -> None:
    ...
    def _apply_sheet_formatting(self, ws, max_row: int) -> None:
    ...
    def _create_colony_sheet(self, workbook: Workbook, colony_id: str, colony_data: Dict[str, Any]) -> None:
        ...
        if time_series:
            ...
            for r_idx, row_data in enumerate(dataframe_to_rows(df, index=False, header=True), start_row):
    ...
    def _create_colony_performance_chart(self, ws, data_rows: int, start_row: int) -> None:
        ...
        data = Reference(ws, min_col=2, min_row=start_row, max_col=4, max_row=start_row + data_rows)
        categories = Reference(ws, min_col=1, min_row=start_row + 1, max_row=start_row + data_rows)
    ...
    def _create_comparative_analysis_sheet(self, workbook: Workbook, colony_data: Dict[str, Any]) -> None:
    ...
    def _create_comparison_chart(self, ws, num_colonies: int, start_row: int) -> None:
        ...
        # Data for comparison
        data = Reference(ws, min_col=2, min_row=start_row - 1, max_col=6, max_row=start_row + num_colonies - 1)
        categories = Reference(ws, min_col=1, min_row=start_row, max_row=start_row + num_colonies - 1)
    ...
    def _create_mortality_overview_sheet(self, workbook: Workbook, mortality_data: Dict[str, Any]) -> None:
        ...
        summary_data = [
            ...
            ["Average Collapse Duration (days)", summary.get('average_collapse_duration_days', 0)]
        ]
    ...
    def _create_collapse_analysis_sheet(self, workbook: Workbook, mortality_data: Dict[str, Any]) -> None:
    ...
    def _create_collapse_timeline_chart(self, ws, num_events: int) -> None:
        """Create collapse timeline chart"""
    ...
    def _create_survival_factors_sheet(self, workbook: Workbook, mortality_data: Dict[str, Any]) -> None:
    ...
    def export_comprehensive_report(self, all_data: Dict[str, Any]) -> str:
        ...
        self._create_population_dynamics_sheet(workbook, all_data.get('simulation_data', {}))
        self._create_energy_analysis_sheet(workbook, all_data.get('simulation_data', {}))
        self._create_foraging_performance_sheet(workbook, all_data.get('simulation_data', {}))
        self._create_environmental_conditions_sheet(workbook, all_data.get('simulation_data', {}))
    ...
    def _create_parameter_analysis_sheet(self, workbook: Workbook, parameter_data: Dict[str, Any]) -> None:
