...
class TestVisualizationType:
    ...
    def test_visualization_type_values(self):
        ...
        assert VisualizationType.COLONY_OVERVIEW == "colony_overview"
        assert VisualizationType.POPULATION_TRENDS == "population_trends"
        assert VisualizationType.FORAGING_ACTIVITY == "foraging_activity"
        assert VisualizationType.SPATIAL_DISTRIBUTION == "spatial_distribution"
        assert VisualizationType.COMMUNICATION_NETWORK == "communication_network"
        assert VisualizationType.HEALTH_MONITORING == "health_monitoring"
        assert VisualizationType.RESOURCE_DYNAMICS == "resource_dynamics"
        assert VisualizationType.DANCE_COMMUNICATION == "dance_communication"
        assert VisualizationType.RECRUITMENT_FLOW == "recruitment_flow"
        assert VisualizationType.ENVIRONMENTAL_CONDITIONS == "environmental_conditions"
...
class TestVisualizationData:
    ...
    def test_json_serialization(self):
        ...
        assert parsed_data["data_type"] == VisualizationType.POPULATION_TRENDS
