...
from bstew.core.foraging_integration import (
    ...
    AdvancedPatchSelector, PatchInfo, PatchResourceType,
    BumblebeeCommunicationSystem
)
from bstew.components.proboscis_matching import ProboscisCorollaSystem, AccessibilityResult
...
class TestIntegratedForagingSystem:
    ...
    def setup_method(self):
        ...
        self.mock_communication_integrator = Mock(spec=BumblebeeCommunicationSystem)
    ...
    def test_foraging_step_new_session(self):
        ...
        # Mock bumblebee communication system (scent-based, no dance)
        self.mock_communication_integrator.potentially_leave_scent_mark.return_value = {
            "scent_marked": True,
            "scent_strength": 0.8,
            "memory_updated": True
        }
    ...
    def test_no_patches_available(self):
        ...
        # Mock bumblebee communication system for the case where it's needed
        self.mock_communication_integrator.potentially_leave_scent_mark.return_value = {
            "scent_marked": False,
            "scent_strength": 0.0,
    ...
    def test_flower_accessibility_evaluation(self):
        ...
        from bstew.components.proboscis_matching import AccessibilityLevel
...
class TestForagingSystemIntegration:
    ...
    def test_full_foraging_workflow(self):
        ...
        for resource_patch in self.patches:
            assert resource_patch.patch_id in self.foraging_system.patch_database
